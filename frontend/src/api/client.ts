...
export const corporationsAPI = {
  ...
  detail: (id: string) => client.get<Corporation>(`/corporations/${id}`),
  ...
  facilities: (id: string) => client.get(`/corporations/${id}/facilities`),
};
...
export const facilitiesAPI = {
  ...
  detail: (id: string) => client.get<Facility>(`/facilities/${id}`),
...
export const analyticsAPI = {
  ...
  regional: (fiscalYear?: number) =>
    ...
    }>("/analytics/regional", { params: { fiscal_year: fiscalYear } }),
...
export const collectionAPI = {
  ...
  detail: (logId: number) => client.get(`/collection-logs/${logId}`),

  trigger: (scriptName: string) =>
    client.post(`/collection-logs/trigger/${scriptName}`),

  stats: () => client.get("/collection-logs/stats/summary"),
};

export const monitoringAPI = {
  metrics: () => client.get<SystemMetrics>("/monitoring/metrics"),
};
